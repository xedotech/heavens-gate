        ...
        <section className="menu-screen settings-screen" aria-labelledby="settings-title">
          ...
          <div className="settings-grid">
            ...
            <fieldset className="toggle-fieldset"><legend>Accessibility</legend>
              ...
              <label><span><strong>Toggle aim</strong><small>Click to enter ADS, click again to exit — no holding</small></span><input type="checkbox" checked={settings.aimToggle} onChange={(event) => updateSettings({ aimToggle: event.target.checked })} /></label>
